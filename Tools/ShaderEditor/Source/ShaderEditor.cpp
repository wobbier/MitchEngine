...
void ShaderEditor::DrawPinIcon( const Pin& pin, bool connected, int alpha )
{
    IconType iconType;
...
void ShaderEditor::ShowLeftPane( float paneWidth )
{
    auto& io = ImGui::GetIO();
    ...
    int saveIconWidth = 100;//GetTextureWidth(m_SaveIcon);
    int saveIconHeight = 100;//GetTextureWidth(m_SaveIcon);
    int restoreIconWidth = 100;//GetTextureWidth(m_RestoreIcon);
    int restoreIconHeight = 100;//GetTextureWidth(m_RestoreIcon);
...
void ShaderEditor::BlueprintStart()
{
...
void ShaderEditor::DrawBlueprint()
{
    UpdateTouch();
...
# endif
    ...
    ed::Begin( "Node editor" );
    {
        ...
        util::BlueprintNodeBuilder builder( m_HeaderBackground, GetTextureWidth(), GetTextureHeight() );
