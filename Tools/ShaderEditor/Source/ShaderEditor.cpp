...
void ShaderEditor::HandleAddNodeConxtualMenu()
{
# if 1
...
void ShaderEditor::DrawOrdinals()
{
...
void ShaderEditor::DrawComments()
{
    // Comment Nodes
    for( auto& node : m_Nodes )
    {
...
void ShaderEditor::DrawHoudiniNodes()
{
    // Houdini Nodes
    for( auto& node : m_Nodes )
    {
...
void ShaderEditor::DrawTreeNodes()
{
    // Tree nodes
    for( auto& node : m_Nodes )
    {
...
void ShaderEditor::DrawBasicNodes()
{
