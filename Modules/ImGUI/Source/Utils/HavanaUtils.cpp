...
float HavanaUtils::Label(const std::string& Name)
{
...
bool HavanaUtils::EditableVector3(const std::string& Name, Vector3& Vector, float ResetValue /*= 0.f*/)
{
	ImGui::PushID(Name.c_str());

	float widgetWidth = Label(Name);
...
bool HavanaUtils::EditableVector(const std::string& Name, Vector2& Vector, float ResetValue /*= 0.f*/)
{
	ImGui::PushID(Name.c_str());

	float widgetSize = Label(Name);
