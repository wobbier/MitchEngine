...
namespace ultralight {
    ...
    bool JSValue::IsNull() const {
        return JSValueGetType( ctx_, instance() ) == kJSTypeNull;
    }

    bool JSValue::IsUndefined() const {
        return JSValueGetType( ctx_, instance() ) == kJSTypeUndefined;
    }

    bool JSValue::IsBoolean() const {
        return JSValueGetType( ctx_, instance() ) == kJSTypeBoolean;
    }

    bool JSValue::IsNumber() const {
        return JSValueGetType( ctx_, instance() ) == kJSTypeNumber;
    }

    bool JSValue::IsString() const {
        return JSValueGetType( ctx_, instance() ) == kJSTypeString;
    }

    bool JSValue::IsObject() const {
        return JSValueGetType( ctx_, instance() ) == kJSTypeObject;
    }

    bool JSValue::IsArray() const {
        return JSValueIsArray( ctx_, instance() );
    }
    ...
    bool JSValue::ToBoolean() const {
        return JSValueToBoolean( ctx_, instance() );
    }

    double JSValue::ToNumber() const {
        return JSValueToNumber( ctx_, instance(), nullptr );
    }
    ...
    JSValue::operator JSObjectRef() const {
        return ToObject();
    }

    JSValue::operator JSArray() const {
        return ToArray();
    }

    JSValue::operator JSFunction() const {
        return ToFunction();
    }

    JSValueRef JSValue::instance() const {
        return instance_;
    }
...
#define GetVectorConst() (*reinterpret_cast<const std::vector<JSValue>*>(instance_))
    ...
    bool JSFunction::IsValid() const {
        return !!instance_ && JSObjectIsFunction( ctx_, instance_ );
    }
